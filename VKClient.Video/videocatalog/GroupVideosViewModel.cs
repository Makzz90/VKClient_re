  ...
  public class GroupVideosViewModel : ViewModelBase, ICollectionDataProvider<VKList<VKClient.Common.Backend.DataObjects.Video>, VideoHeader>
  {
    ...
    public bool CanUploadVideo
    {
      ...
      private set
      {
        ...
        this.NotifyPropertyChanged<bool>((() => this.CanUploadVideo));
      }
    }
    ...
    public Func<VKList<VKClient.Common.Backend.DataObjects.Video>, ListWithCount<VideoHeader>> ConverterFunc
    {
      get
      {
        return (Func<VKList<VKClient.Common.Backend.DataObjects.Video>, ListWithCount<VideoHeader>>) (vData =>
        {
          ...
          {
            VideoHeader videoHeader = new VideoHeader(video,  null, vData.profiles, vData.groups, StatisticsActionSource.videos_group, this._ownerId.ToString() + "_" + this._albumId.ToString(), false, 0, 0L);
    ...
    public GroupVideosViewModel(long ownerId)
    {
      ...
      this._videosGenCol.MergedCollection.Merge( this._headerCollObj.Coll);
      this._videosGenCol.MergedCollection.Merge( this._albumsHeaderCollObj.Coll);
      this._videosGenCol.MergedCollection.Merge( this._albumsCollObj.Coll);
      this._videosGenCol.MergedCollection.Merge( this._videosHeaderCollObj.Coll);
      this._videosGenCol.MergedCollection.Merge( this._videosGenCol.Collection);
        ...
        if (!this._loadedBaseInfo)
            VideoService.Instance.GetVideoDataExt(this._ownerId, (Action<BackendResult<GetVideosDataExtResponse, ResultCode>>)(res => Execute.ExecuteOnUIThread((Action)(() =>
            {
                ...
                if (res.ResultCode == ResultCode.Succeeded)
                {
                    ...
                    CollectionObject<SectionHeaderViewModel> videosHeaderCollObj = this._videosHeaderCollObj;
                    ...
                    sectionHeaderViewModel.HeaderOptions = new List<HeaderOption>()
            {
              ...
              new HeaderOption()
              {
                ...
                Name = CommonResources.VideoCatalog_Uploaded
                    ...
                    videosHeaderCollObj.Data = sectionHeaderViewModel;
            ...
            VideoService.Instance.GetVideos(Math.Abs(this._ownerId), this._ownerId < 0, offset, count, (Action<BackendResult<VKList<VKClient.Common.Backend.DataObjects.Video>, ResultCode>>)(res =>
            {
                if (res.ResultCode == ResultCode.Succeeded)
