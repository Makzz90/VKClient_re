...
namespace VKClient.Common.Framework.SharpDXExt
{
  internal class DrawingSurfaceContentProvider : DrawingSurfaceContentProviderNativeBase
  {
    ...
    public DrawingSurfaceContentProvider(SharpDXContext context, object lockObject)
    {
      ...
      using (Device device = new Device(DriverType.Hardware, DeviceCreationFlags.BgraSupport, new FeatureLevel[5]{ FeatureLevel.Level_11_1, FeatureLevel.Level_11_0, FeatureLevel.Level_10_1, FeatureLevel.Level_10_0, FeatureLevel.Level_9_3 }))
      {
    ...
    public override void Disconnect()
    {
      ...
      if (this.sharpDXContext == null || !this.sharpDXContext.IsDisposed)
        return;
      this.sharpDXContext =  null;
    }

    public override void PrepareResources(System.DateTime presentTargetTime, out Bool isContentDirty)
    {
