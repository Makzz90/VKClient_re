...
namespace VKClient.Common.Profiles.Shared.ViewModels
{
  public class ProfileMarketViewModel : ViewModelBase, IMediaHorizontalItemsViewModel, ICollectionDataProvider2<VKList<Product>, MediaListItemViewModelBase>
  {
    ...
    private static List<MediaListItemViewModelBase> CreateItems(IProfileData profileData)
    {
      ...
      if ((profileData != null ? profileData.products :  null) == null)
        return itemViewModelBaseList;
      itemViewModelBaseList.AddRange((IEnumerable<MediaListItemViewModelBase>)Enumerable.Select<Product, ProductMediaListItemViewModel>(profileData.products, (Func<Product, ProductMediaListItemViewModel>)(item => new ProductMediaListItemViewModel(item))));
      return itemViewModelBaseList;
    }
