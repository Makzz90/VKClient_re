...
namespace VKClient.Common.Stickers.Views
{
  public class StoreTabsUC : UserControl
  {
    ...
    private StickersStoreViewModel ViewModel
    {
      get
      {
        return this.DataContext as StickersStoreViewModel;
      }
    }
    ...
    private void TabPopular_OnTap(object sender, GestureEventArgs e)
    {
      this.ViewModel.StickersListSource = StickersStoreViewModel.CurrentSource.Popular;
    }

    private void TabNew_OnTap(object sender, GestureEventArgs e)
    {
      this.ViewModel.StickersListSource = StickersStoreViewModel.CurrentSource.New;
    }

    private void TabFree_OnTap(object sender, GestureEventArgs e)
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/VKClient.Common;component/Stickers/Views/StoreTabsUC.xaml", UriKind.Relative));
    }
  }
}
