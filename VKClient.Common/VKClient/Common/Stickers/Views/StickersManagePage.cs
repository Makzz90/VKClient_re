...
namespace VKClient.Common.Stickers.Views
{
  public class StickersManagePage : PageBase
  {
    ...
    private void Deactivate_OnTap(object sender, GestureEventArgs e)
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/VKClient.Common;component/Stickers/Views/StickersManagePage.xaml", UriKind.Relative));
