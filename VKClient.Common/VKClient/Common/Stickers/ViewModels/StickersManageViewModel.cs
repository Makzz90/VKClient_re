...
namespace VKClient.Common.Stickers.ViewModels
{
  public class StickersManageViewModel : ViewModelStatefulBase, IHandle<StickersPackActivatedDeactivatedEvent>, IHandle
  {
    ...
    public ObservableCollection<StockItemHeader> ActiveStickers { get { return new ObservableCollection<StockItemHeader>(); } }

    public ObservableCollection<StockItemHeader> HiddenStickers { get { return new ObservableCollection<StockItemHeader>(); } }
    ...
    public Visibility ActiveStickersVisibility
    {
      get
      {
        return (this.ActiveStickers.Count > 0).ToVisiblity();
      }
    }
    ...
    public Visibility HiddenStickersVisibility
    {
      get
      {
        return (this.HiddenStickers.Count > 0).ToVisiblity();
      }
    }
    ...
    public bool StickersAutoSuggestEnabled
    {
      ...
      set
      {
        ...
        EventAggregator.Current.Publish((object) new AutoSuggestEnabledChangedEvent());
      }
    }
    ...
    public bool IsStickersReorderingEnabled
    {
      get
      {
        return this.ActiveStickers.Count > 1;
      }
    }
