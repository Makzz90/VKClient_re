...
namespace VKClient.Common.Profiles.Shared.ViewModels
{
  public class ProductMediaListItemViewModel : MediaListItemViewModelBase
  {
    ...
    public Visibility PriceVisibility
    {
      get
      {
        return this._product.price == null || string.IsNullOrEmpty(this._product.price.text) ? Visibility.Collapsed : Visibility.Visible;
      }
    }
      ...
      : base(ProfileMediaListItemType.Product)
    {
      ...
      Photo photo = product.photos == null || product.photos.Count <= 0 ? (Photo) null : product.photos[0];
      if (photo != null)
