  ...
  public class ProfileInfoViewModelBase : ViewModelBase
  {
    ...
    private List<InfoListItem> GetDesignData()
    {
      return new List<InfoListItem>()
      {
        new InfoListItem()
        {
          IconUrl = "/Resources/Profile/ProfileStatus.png",
          Text = "May my enemies live long so they can see p..."
        },
        new InfoListItem()
        {
          IconUrl = "/Resources/Profile/ProfileFriends.png",
          Text = "680 друзей · 5 общих"
        },
        new InfoListItem()
        {
          IconUrl = "/Resources/Profile/ProfileFollowers.png",
          Text = "1 389 подписчиков"
        },
        new InfoListItem()
        {
          IconUrl = "/Resources/Profile/ProfileBirthday.png",
          Text = "День рождения: 25 декабря"
        },
        new InfoListItem()
        {
          IconUrl = "/Resources/Profile/ProfileHome.png",
          Text = "Город: Санкт-Петербург"
        },
        new InfoListItem()
        {
          IconUrl = "/Resources/Profile/ProfileWork.png",
