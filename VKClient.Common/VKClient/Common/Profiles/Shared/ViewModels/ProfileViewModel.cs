    ...
    public class ProfileViewModel : ViewModelBase, ICollectionDataProvider<WallData, IVirtualizable>, IHandle<WallPostDeleted>, IHandle, IHandle<WallPostAddedOrEdited>, IHandle<WallPostPinnedUnpinned>, IHandle<GroupMembershipStatusUpdated>, IHandle<FriendRequestAcceptedDeclined>, IHandle<FriendRemoved>, IHandle<FriendRequestSent>, IHandle<SubscriptionCancelled>, IHandle<BaseDataChangedEvent>, IHandle<CommunityLinkAddedOrEdited>, IHandle<CommunityLinkDeleted>, IHandle<CommunityManagerChanged>, IHandle<CommunityInformationChanged>, IHandle<CommunityServicesChanged>
    {
        ...
        public ProfileHeaderViewModelBase HeaderViewModel
        {
            ...
            private set
            {
                ...
                this.NotifyPropertyChanged<ProfileHeaderViewModelBase>((System.Linq.Expressions.Expression<Func<ProfileHeaderViewModelBase>>)(() => this.UserHeaderViewModel));
                this.NotifyPropertyChanged<ProfileHeaderViewModelBase>((System.Linq.Expressions.Expression<Func<ProfileHeaderViewModelBase>>)(() => this.GroupHeaderViewModel));
            }
        }
        ...
        public ProfileHeaderViewModelBase UserHeaderViewModel
        {
            get
            {
                return (ProfileHeaderViewModelBase)(this._headerViewModel as UserProfileHeaderViewModel);
            }
        }
        ...
        public ProfileHeaderViewModelBase GroupHeaderViewModel
        {
            get
            {
                return (ProfileHeaderViewModelBase)(this._headerViewModel as GroupProfileHeaderViewModel);
            }
        }
                    ...
                    default:
                        if (this._userData != null)
                        {
                            switch (this._status)
                            {
                                case ProfileLoadingStatus.Deleted:
                                    return string.Format("{0} {1}", (object)CommonResources.UserDeleted, (object)CommonResources.InformationUnavailable);
                                case ProfileLoadingStatus.Banned:
                                    return string.Format("{0} {1}", (object)CommonResources.UserBanned, (object)CommonResources.InformationUnavailable);
                                case ProfileLoadingStatus.Blacklisted:
                                    return string.Format("{0} {1}", (object)string.Format(CommonResources.UserBlacklisted, (object)this._userData.user.first_name), (object)CommonResources.InformationUnavailable);
                        ...
                        if (this._groupData != null)
                        {
                            switch (this._status)
                            {
                                case ProfileLoadingStatus.Deleted:
                                case ProfileLoadingStatus.Banned:
                                    return string.Format("{0} {1}", (object)CommonResources.Group_Banned, (object)CommonResources.InformationUnavailable);
                                case ProfileLoadingStatus.Blacklisted:
        ...
        public Visibility LoadingStatusVisibility
        {
            get
            {
                return this.User100DescriptionVisibility != Visibility.Visible ? Visibility.Visible : Visibility.Collapsed;
            }
        }
        ...
        public Visibility User100DescriptionVisibility
        {
            get
            {
                return this._status != ProfileLoadingStatus.Loading && this._status != ProfileLoadingStatus.LoadingFailed && (this._userData != null && this.Id == 100L) ? Visibility.Visible : Visibility.Collapsed;
            }
        }
        ...
        public Visibility ChoosePhotoMenuItemVisibility
        {
            get
            {
                return this.Id >= 0L ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        private bool IsAllDataBlockerStatus
        {
            get
            {
                if (this._status != ProfileLoadingStatus.Loading)
                    return this._status == ProfileLoadingStatus.LoadingFailed;
                return true;
            }
        }
        ...
        public Visibility MembershipVisibility
        {
            get
            {
                return this.IsAllDataBlockerStatus || !this.CanShowMembership ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility InfoVisibility
        {
            get
            {
                return this.IsAllDataBlockerStatus || !this.CanShowInfo ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility MediaVisibility
        {
            get
            {
                return this.IsAllDataBlockerStatus || !this.CanShowMedia || !this._mediaViewModel.CanDisplay ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility SuggestedPostponedVisibility
        {
            get
            {
                return this.IsAllDataBlockerStatus || !this.CanShowSuggestedPostponed || (this._suggestedPostponedViewModel == null || !this._suggestedPostponedViewModel.CanDisplay) ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility PostsVisibility
        {
            get
            {
                return this.IsAllDataBlockerStatus || !this.CanShowPosts ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility PostsNotLoadingVisibility
        {
            get
            {
                return (this._allWallDataPrefetched == null || this._allWallDataPrefetched.TotalCount <= 0) && (this._ownerWallDataPrefetched == null || this._ownerWallDataPrefetched.TotalCount <= 0) ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public bool CanPost
        {
            get
            {
                if (this._profileData != null)
                    return this._profileData.CanPost;
                return false;
            }
        }
        ...
        public bool CanSuggestAPost
        {
            ...
            {
                if (this._profileData != null)
                    return this._profileData.CanSuggestAPost;
                return false;
            }
        }
        ...
        public bool CanFaveUnfave
        {
            get
            {
                return this._profileData != null && this.Id != AppGlobalStateManager.Current.LoggedInUserId && (this.Id >= 0L || this._groupData == null || this._groupData.group.Privacy != GroupPrivacy.Private);
            }
        }
        ...
        public bool CanSubscribeUnsubscribe
        {
            get
            {
                if (this._profileData == null || this.Id == AppGlobalStateManager.Current.LoggedInUserId)
                    return false;
                if (this.Id < 0L)
                {
        ...
        public bool CanBanUnban
        {
            get
            {
                if (this._profileData != null && this.Id > 0L)
        ...
        public bool CanPinToStart
        {
            get
            {
                if (this._profileData != null && !this.IsTileExist() && this._status != ProfileLoadingStatus.Banned)
                    return this._status != ProfileLoadingStatus.Deleted;
                return false;
            }
        }
        ...
        public bool CanUserUnsubscribe
        {
            get
            {
                if (this._profileData == null || this.Id <= 0L || (this.Id == AppGlobalStateManager.Current.LoggedInUserId || this._profileData.areFriendsStatus != 1))
                    return false;
                if (this._status != ProfileLoadingStatus.Banned)
                    return this._status == ProfileLoadingStatus.Deleted;
                return true;
            }
        }
        ...
        public bool CanRemoveFromFriends
        {
            get
            {
                if (this._profileData == null || this.Id <= 0L || (this.Id == AppGlobalStateManager.Current.LoggedInUserId || this._profileData.areFriendsStatus != 3))
                    return false;
                if (this._status != ProfileLoadingStatus.Banned)
                    return this._status == ProfileLoadingStatus.Deleted;
                return true;
        ...
        public GenericCollectionViewModel<WallData, IVirtualizable> WallVM { get; set; }
        ...
        public ProfileViewModel(long id, string name = "", string source = "")
        {
            ...
            if (this.Id > 0L)
            {
                ...
                string str = source != "" ? source : (string)null;
                openUserEvent.Source = str;
                current.Publish((object)openUserEvent);
            }
            else
            {
                ...
                {
                    GroupId = -id,
                    Source = (source != "" ? source : (string)null)
                });
            }
            this.WallVM = new GenericCollectionViewModel<WallData, IVirtualizable>((ICollectionDataProvider<WallData, IVirtualizable>)this)
            {
                LoadCount = 10,
                ReloadCount = 20
            };
        ...
        private string ComposeGroupBlacklistedText()
        {
            ...
            if (banInfo.reason > 0)
            {
                ...
                if (!string.IsNullOrEmpty(reasonById))
                    str += string.Format("{0}: {1}", (object)CommonResources.Group_BanReason, (object)reasonById);
            }
            if (banInfo.end_date > 0L)
            {
                ...
                if (!string.IsNullOrEmpty(str))
                    str += "\n";
                str += string.Format("{0}: {1}", (object)CommonResources.Group_Blacklisted_BlockedTill, (object)UIStringFormatterHelper.FormateDateForEventUI(dateTime));
            }
            if (!string.IsNullOrEmpty(banInfo.comment))
            {
                if (!string.IsNullOrEmpty(str))
                    str += "\n";
                str += string.Format("{0}: {1}", (object)CommonResources.Group_Blacklisted_Comment, (object)banInfo.comment);
            }
        ...
        {
            this._status = status;
            this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>)(() => this.LoadingStatusText));
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.User100DescriptionVisibility));
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.LoadingStatusVisibility));
            ...
            if (loadingStatusUpdated == null)
                return;
            int num = (int)this._status;
            loadingStatusUpdated((ProfileLoadingStatus)num);
        }

        private void NotifyProfileListItemsProperties()
        {
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.MembershipVisibility));
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.InfoVisibility));
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.MediaVisibility));
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.SuggestedPostponedVisibility));
        ...
        private void ParseLoadingStatus()
        {
            if (this._userData != null)
            {
                ...
                if (user.id == 100L || user.id == 101L || user.id == 333L)
                {
        ...
        private void ProcessData()
        {
            ...
            {
                UpdatedCallback = (Action)(() => Execute.ExecuteOnUIThread((Action)(() => this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.SuggestedPostponedVisibility)))))
            };
            ...
            Action<bool> action = (Action<bool>)(isAllPosts => DelayedExecutorUtil.Execute((Action)(() => this.LoadWall(false, null)), 50));
        ...
        private void LoadWall(bool deletePrefetchedData, Action callback = null)
        {
            ...
            {
                this._allWallDataPrefetched = (WallData)null;
                this._ownerWallDataPrefetched = (WallData)null;
            }
        ...
        public void GetData(GenericCollectionViewModel<WallData, IVirtualizable> caller, int offset, int count, Action<BackendResult<WallData, ResultCode>> callback)
        {
            if (offset == 0)
            {
                if (this._postsToggleViewModel.IsAllPosts && this._allWallDataPrefetched != null)
                {
                    ...
                    WallData wallData = this._allWallDataPrefetched;
                    backendResult.ResultData = wallData;
                ...
                if (!this._postsToggleViewModel.IsAllPosts && this._ownerWallDataPrefetched != null)
                {
                    ...
                    BackendResult<WallData, ResultCode> backendResult = new BackendResult<WallData, ResultCode>();
                    backendResult.ResultCode = ResultCode.Succeeded;
                    WallData wallData = this._ownerWallDataPrefetched;
                    backendResult.ResultData = wallData;
                    action(backendResult);
                    return;
                }
            ...
            Action<BackendResult<WallData, ResultCode>> _9__1 = null;//
            ...
            WallService.Current.GetWall(this.Id, offset, count, (Action<BackendResult<WallData, ResultCode>>)(response =>
            {
                ...
                Action<BackendResult<WallData, ResultCode>> arg_E4_4;
                if ((arg_E4_4 = _9__1) == null)
                {
                    arg_E4_4 = (_9__1 = delegate(BackendResult<WallData, ResultCode> res)
                    {
                        this.LockPostsToggle(false);
                ...
                current.GetWall(id, offset1, count1, arg_E4_4, fetchAll ? "owner" : "all");
        ...
        {
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.PostsVisibility));
            this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>)(() => this.PostsNotLoadingVisibility));
        }
        ...
        public string GetFooterTextForCount(GenericCollectionViewModel<WallData, IVirtualizable> caller, int count)
        {
            ...
            return UIStringFormatterHelper.FormatNumberOfSomething(count, CommonResources.OneWallPostFrm, CommonResources.TwoWallPostsFrm, CommonResources.FiveWallPostsFrm, true, (string)null, false);
        }
        ...
        private void DeletedCallback(WallPostItem obj)
        {
            ...
            {
                WallPost wallPost = this._allWallDataPrefetched.wall.FirstOrDefault<WallPost>((Func<WallPost, bool>)(w =>
                {
            ...
            {
                WallPost wallPost = this._ownerWallDataPrefetched.wall.FirstOrDefault<WallPost>((Func<WallPost, bool>)(w =>
                {
                    if (w.id == obj.WallPost.id)
                        return w.to_id == obj.WallPost.to_id;
                    return false;
        ...
        public void Handle(WallPostAddedOrEdited message)
        {
            ...
            Execute.ExecuteOnUIThread((Action)(() =>
            {
                ...
                {
                    int num;
                    if (this.WallVM.Collection.Any<IVirtualizable>())
                    {
                        WallPostItem wallPostItem = this.WallVM.Collection.First<IVirtualizable>() as WallPostItem;
        ...
        public void NavigateToNewWallPost()
        {
            if (this._profileData == null)
                return;
            Navigator.Current.NavigateToNewWallPost(Math.Abs(this.Id), this.Id < 0L, this._profileData.AdminLevel, this._groupData != null && this._groupData.group.GroupType == GroupType.PublicPage, false, false);
        }
        ...
        public void PinToStart()
        {
            ...
            this.SetInProgress(true, "");
            SecondaryTileCreator.CreateTileFor(this.Id, this.Id < 0L, name, (Action<bool>)(res =>
            {
                this.SetInProgress(false, "");
                this._isLoading = false;
                Execute.ExecuteOnUIThread((Action)(() =>
                ...
                if (res)
                    return;
                Execute.ExecuteOnUIThread((Action)(() => new GenericInfoUC().ShowAndHideLater(CommonResources.Error, (FrameworkElement)null)));
            }), photoMax);
        }
        ...
        public void BanUnban()
        {
            ...
            if (this.IsBlacklistedByMe)
            {
                ...
                {
                    GenericInfoUC.ShowBasedOnResult((int)res.ResultCode, CommonResources.BannedUsers_UserIsUnbanned, (VKRequestsDispatcher.Error)null);
                    if (res.ResultCode != ResultCode.Succeeded)
                        return;
                    Execute.ExecuteOnUIThread((Action)(() =>
                    {
                        ...
                        current.Publish((object)bannedOrUnbannedEvent);
                        this.LoadInfo(true);
                    }));
                });
                instance.UnbanUsers(user_ids, callback);
            }
            else
                AccountService.Instance.BanUser(this.Id, (Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>>)(res =>
                {
                    GenericInfoUC.ShowBasedOnResult((int)res.ResultCode, CommonResources.BannedUsers_UserIsBanned, (VKRequestsDispatcher.Error)null);
                    if (res.ResultCode != ResultCode.Succeeded)
                        return;
                    Execute.ExecuteOnUIThread((Action)(() =>
                    {
        ...
        public void RemoveFromFriends()
        {
            if (this._userData == null || this.Id < 0L)
                return;
            UsersService.Instance.FriendAddDelete(this.Id, false, (Action<BackendResult<OwnCounters, ResultCode>>)(res =>
            {
        ...
        private void FaveUnfaveUser()
        {
            ...
            FavoritesService.Instance.FaveAddRemoveUser(this.Id, !isFavorite, (Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>>)(res =>
            {
                GenericInfoUC.ShowBasedOnResult((int)res.ResultCode, !isFavorite ? CommonResources.Bookmarks_UserIsAdded : CommonResources.Bookmarks_UserIsRemoved, (VKRequestsDispatcher.Error)null);
                if (res.ResultCode != ResultCode.Succeeded)
                    return;
                Execute.ExecuteOnUIThread((Action)(() =>
                {
                    ...
                    current.Publish((object)favedOrUnfavedEvent);
                }));
            }));
        }
        ...
        {
            bool isFavorite = this.IsFavorite;
            FavoritesService.Instance.FaveAddRemoveGroup(-this.Id, !isFavorite, (Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>>)(res =>
            {
                GenericInfoUC.ShowBasedOnResult((int)res.ResultCode, !isFavorite ? CommonResources.Bookmarks_CommunityIsAdded : CommonResources.Bookmarks_CommunityIsRemoved, (VKRequestsDispatcher.Error)null);
                if (res.ResultCode != ResultCode.Succeeded)
                    return;
                Execute.ExecuteOnUIThread((Action)(() =>
                {
            ...
            if (this.IsSubscribed)
            {
                ...
                Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback = (Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>>)(res =>
                {
                    ...
                    Execute.ExecuteOnUIThread((Action)(() =>
                    {
                        ...
                        current.Publish((object)unsubscribedToEvent);
                    }));
                });
                current1.WallSubscriptionsUnsubscribe(ownerIds, callback);
            }
            else
                WallService.Current.WallSubscriptionsSubscribe(this.Id, (Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>>)(res =>
                {
        ...
        public void OpenProfilePhotos()
        {
            if (this._status == ProfileLoadingStatus.Banned || this._status == ProfileLoadingStatus.Deleted)
                return;
            Navigator.Current.NavigateToImageViewer("profile", 1, this.Id, this.Id < 0L, -1, 0, new List<Photo>(), (Func<int, Image>)(id => (Image)null));
        }
        ...
        public void DeletePhoto()
        {
            ...
            ProfilesService.Instance.DeleteProfilePhoto(this.Id, (Action<BackendResult<string, ResultCode>>)(res => Execute.ExecuteOnUIThread((Action)(() =>
            {
                ...
                if (this._profileData != null)
                {
                    ...
                    if (this._groupData != null)
                        EventAggregator.Current.Publish((object)new CommunityPhotoChanged()
                        {
        ...
        public void UploadProfilePhoto(Stream stream, Rect rect)
        {
            ...
            ImagePreprocessor.PreprocessImage(stream, VKConstants.ResizedImageSize, true, (Action<ImagePreprocessResult>)(preprocessRes =>
            {
                ...
                stream1.Close();
                ProfilesService.Instance.SaveProfilePhoto(this.Id, ImagePreprocessor.GetThumbnailRect((double)preprocessRes.Width, (double)preprocessRes.Height, rect), numArray, (Action<BackendResult<ProfilePhoto, ResultCode>>)(res =>
                {
        ...
        private string GetLink()
        {
            ...
            {
                User user = this._userData.user;
                str2 = str1 + (!string.IsNullOrEmpty(user.domain) ? user.domain : "id" + (object)user.id);
            }
            else
            {
                Group group = this._groupData.group;
                str2 = str1 + (!string.IsNullOrEmpty(group.screen_name) ? group.screen_name : "club" + (object)group.id);
            }
            return str2;
        }
        ...
        public void Handle(CommunityLinkAddedOrEdited message)
        {
            ...
            else
            {
                if (this._groupData.group.links == null)
                    return;
                GroupLink groupLink = this._groupData.group.links.FirstOrDefault<GroupLink>((Func<GroupLink, bool>)(l => l.id == message.Link.id));
                if (groupLink == null)
                    return;
        ...
        public void Handle(CommunityLinkDeleted message)
        {
            if (this._groupData == null || message.CommunityId != this._groupData.Id || this._groupData.group.links == null)
                return;
            GroupLink groupLink = this._groupData.group.links.FirstOrDefault<GroupLink>((Func<GroupLink, bool>)(l => l.id == message.LinkId));
            if (groupLink == null)
                return;
        ...
        public void Handle(CommunityManagerChanged message)
        {
            ...
            switch (message.EditingMode)
            {
                ...
                case EditingMode.Editing:
                    ...
                    if (this._groupData.contactsUsers == null)
                        this._groupData.contactsUsers = new List<User>();
                    GroupContact groupContact1 = this._groupData.group.contacts.FirstOrDefault<GroupContact>((Func<GroupContact, bool>)(c => c.user_id == message.ManagerId));
                ...
                case EditingMode.Removing:
                    if (this._groupData.contactsUsers == null || this._groupData.group.contacts == null)
                        break;
                    GroupContact groupContact2 = this._groupData.group.contacts.FirstOrDefault<GroupContact>((Func<GroupContact, bool>)(c => c.user_id == message.ManagerId));
                    if (groupContact2 != null)
                        this._groupData.group.contacts.Remove(groupContact2);
                    User user = this._groupData.contactsUsers.FirstOrDefault<User>((Func<User, bool>)(c => c.id == message.ManagerId));
                    if (user == null)
                        break;
