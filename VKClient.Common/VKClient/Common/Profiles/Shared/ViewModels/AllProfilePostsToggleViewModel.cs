...
namespace VKClient.Common.Profiles.Shared.ViewModels
{
    public class AllProfilePostsToggleViewModel : ViewModelBase
    {
        ...
        public string AllPostsText { get; set; }

        public Brush AllPostsForeground
        {
            get
            {
                return (Brush)Application.Current.Resources[this._isAllPosts ? (object)"PhoneProfilePostsToggleActiveBrush" : (object)"PhoneProfilePostsToggleInactiveBrush"];
            }
        }
