  ...
  public class PostsSearchPage : PageBase
  {
    ...
    protected override void HandleOnNavigatedTo(NavigationEventArgs e)
    {
      ...
      if (!this._isInitialized)
      {
        ...
        string str1 = "";
        long result;
        if (long.TryParse(this.NavigationContext.QueryString["OwnerId"], out result))
          this.ucNewsSearch.Init(result, "", true);
        if (this.NavigationContext.QueryString.ContainsKey("NameGen"))
          str1 = this.NavigationContext.QueryString["NameGen"];
        string str2 = "";
        if (result > 0L)
        {
          if (!string.IsNullOrEmpty(str1))
            str2 = string.Format(CommonResources.SearchByUserPosts, (object) str1);
        }
        else
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/VKClient.Common;component/Profiles/Shared/Views/PostsSearchPage.xaml", UriKind.Relative));
