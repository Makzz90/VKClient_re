...
namespace VKClient.Common.Profiles.Users.ViewModels
{
  public class UserMembershipInfo : MembershipInfoBase
  {
    ...
    public override Visibility VisibilityButtonSendMessage
    {
      get
      {
        return this._userData != null && this._userData.Id != AppGlobalStateManager.Current.LoggedInUserId && this._userData.user.can_write_private_message != 0 ? Visibility.Visible : Visibility.Collapsed;
      }
    }
    ...
    public override Visibility VisibilityButtonPrimary
    {
      get
      {
        return this._userData == null || this._userData.Id == AppGlobalStateManager.Current.LoggedInUserId || this.VisibilityButtonSecondary == Visibility.Visible ? Visibility.Collapsed : Visibility.Visible;
      }
    }
      ...
      get
      {
        ...
        switch (this._userData.friend.friend_status)
        {
          case FriendshipStatus.RequestSent:
            ...
            menuItem1.Header = (object) str;
            MenuItem menuItem2 = menuItem1;
            menuItem2.Click += (RoutedEventHandler) ((sender, args) => this.Remove());
          ...
          case FriendshipStatus.RequestReceived:
            if (this._userData.friend.read_state == 1)
            {
              if (this._userData.Id != AppGlobalStateManager.Current.LoggedInUserId)
              {
                ...
                menuItem3.Header = (object) lowerInvariant;
                MenuItem menuItem4 = menuItem3;
                menuItem4.Click += (RoutedEventHandler) ((sender, args) => this.Add());
            ...
            menuItem5.Header = (object) profileAcceptRequest;
            MenuItem menuItem6 = menuItem5;
            menuItem6.Click += (RoutedEventHandler) ((sender, args) => this.Add());
            MenuItem menuItem7 = new MenuItem();
            string profileKeepAsFollower = CommonResources.Profile_KeepAsFollower;
            menuItem7.Header = (object) profileKeepAsFollower;
          ...
          case FriendshipStatus.Friends:
            ...
            menuItem9.Header = (object) lowerInvariant1;
            MenuItem menuItem10 = menuItem9;
            menuItem10.Click += (RoutedEventHandler) ((sender, args) => this.Remove());
        ...
        UsersService.Instance.FriendAddDelete(userId, add, (Action<BackendResult<OwnCounters, ResultCode>>) (res =>
        {
          ...
          switch (this._userData.friend.friend_status)
          {
            case FriendshipStatus.No:
              ...
              break;
            case FriendshipStatus.RequestSent:
              EventAggregator.Current.Publish((object) new SubscriptionCancelled(userId));
              break;
            case FriendshipStatus.RequestReceived:
              EventAggregator.Current.Publish((object) new FriendRequestAcceptedDeclined(true, userId));
              break;
            case FriendshipStatus.Friends:
              EventAggregator.Current.Publish((object) new FriendRemoved(userId));
              break;
          }
