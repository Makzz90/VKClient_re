...
namespace VKClient.Common.Shared
{
  public class OwnerFullHeaderWithSubscribeViewModel : ViewModelBase, IHandle<GroupMembershipStatusUpdated>, IHandle, IHandle<FriendRequestAcceptedDeclined>, IHandle<FriendRemoved>, IHandle<FriendRequestSent>, IHandle<SubscriptionCancelled>
  {
    ...
    public Visibility SubscribersCountVisibility
    {
      get
      {
        return string.IsNullOrEmpty(this.SubscribersCountStr) ? Visibility.Collapsed : Visibility.Visible;
      }
    }
    ...
    public Visibility SubscribeVisibility
    {
      get
      {
        return !this.CanSubscribe ? Visibility.Collapsed : Visibility.Visible;
      }
    }
    ...
    public Visibility SubscribedVisibility
    {
      get
      {
        return !this.CanUnsubscribe ? Visibility.Collapsed : Visibility.Visible;
      }
    }
    ...
    {
      this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>) (() => this.SubscribeVisibility));
      this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>) (() => this.SubscribedVisibility));
    }
