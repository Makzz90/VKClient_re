...
namespace VKClient.Common.Market.Views
{
  public class ProductListItemUC : UserControl
  {
    ...
    public Product Product
    {
      get
      {
        return (Product) this.GetValue(ProductListItemUC.ProductProperty);
      }
      set
      {
        this.SetValue(ProductListItemUC.ProductProperty, (object) value);
      }
    }
    ...
    private void UpdateImage(IReadOnlyList<Photo> photos)
    {
      if (photos != null && photos.Count > 0)
        ImageLoader.SetUriSource(this.image, photos[0].GetAppropriateForScaleFactor(this.image.Height, 1));
      else
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/VKClient.Common;component/Market/Views/ProductListItemUC.xaml", UriKind.Relative));
