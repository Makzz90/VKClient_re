      ...
      else
      {
        ...
        if (count == 1)
        {
          if (source[0] > 0.8)
            ...
            thumbs[0].SetViewSize(num3 * source[0], num3, false, false);
        }
        else if (count == 2)
        {
          if (str == "ww" && num1 > 1.4 * num4 && source[1] - source[0] < 0.2)
          {
            double width2 = width1;
            double height = Math.Min(width2 / source[0], Math.Min(width2 / source[1], (num3 - num2) / 2.0));
          ...
          else if (str == "ww" || str == "qq")
          {
            ...
            double height = Math.Min(width2 / source[0], Math.Min(width2 / source[1], num3));
            thumbs[0].SetViewSize(width2, height, false, false);
            thumbs[1].SetViewSize(width2, height, false, false);
          }
          else
          {
            double width2 = (width1 - margin) / source[1] / (1.0 / source[0] + 1.0 / source[1]);
            double width3 = width1 - width2 - margin;
            double height = Math.Min(num3, Math.Min(width2 / source[0], width3 / source[1]));
            thumbs[0].SetViewSize(width2, height, false, false);
        ...
        else if (count == 3)
        {
          ...
          {
            double width2 = width1;
            double height1 = Math.Min(width2 / source[0], (num3 - num2) * 0.66);
            thumbs[0].SetViewSize(width2, height1, true, false);
            double width3 = (width1 - margin) / 2.0;
            double height2 = Math.Min(num3 - height1 - num2, Math.Min(width3 / source[1], width3 / source[2]));
          ...
          {
            double height1 = num3;
            double width2 = Math.Min(height1 * source[0], (width1 - margin) * 0.75);
            thumbs[0].SetViewSize(width2, height1, false, false);
            double height2 = source[1] * (num3 - num2) / (source[2] + source[1]);
            double height3 = num3 - height2 - num2;
            double width3 = Math.Min(width1 - width2 - margin, Math.Min(height2 * source[2], height3 * source[1]));
        ...
        else if (count == 4)
        {
          if (str == "wwww")
          {
            ...
            double width3 = val2 * source[1];
            double width4 = val2 * source[2];
            double width5 = val2 * source[3];
          ...
          {
            double height1 = num3;
            double width2 = Math.Min(height1 * source[0], (width1 - margin) * 0.66);
            thumbs[0].SetViewSize(width2, height1, false, false);
            double val2 = (num3 - 2.0 * num2) / (1.0 / source[1] + 1.0 / source[2] + 1.0 / source[3]);
            double height2 = val2 / source[1];
            double height3 = val2 / source[2];
            double height4 = val2 / source[3];
        ...
        else
        {
          ...
          if (num1 > 1.1)
          {
            foreach (double val2 in source)
              doubleList1.Add(Math.Max(1.0, val2));
          }
          else
          {
            foreach (double val2 in source)
              doubleList1.Add(Math.Min(1.0, val2));
          }
          Dictionary<string, List<double>> dictionary = new Dictionary<string, List<double>>();
          int num5;
          dictionary[string.Concat((object) (num5 = count))] = new List<double>()
          {
            ThumbnailLayoutManager.calculateMultiThumbsHeight(doubleList1, width1, margin)
          };
          for (int index = 1; index <= count - 1; ++index)
          {
            int num6;
            dictionary[index.ToString() + "," + (object) (num6 = count - index)] = new List<double>()
            {
              ThumbnailLayoutManager.calculateMultiThumbsHeight(doubleList1.Sublist<double>(0, index), width1, margin),
              ThumbnailLayoutManager.calculateMultiThumbsHeight(doubleList1.Sublist<double>(index, doubleList1.Count), width1, margin)
            };
          }
          for (int index1 = 1; index1 <= count - 2; ++index1)
          {
            ...
            {
              int num6;
              dictionary[index1.ToString() + "," + (object) index2 + "," + (object) (num6 = count - index1 - index2)] = new List<double>()
              {
                ThumbnailLayoutManager.calculateMultiThumbsHeight(doubleList1.Sublist<double>(0, index1), width1, margin),
                ThumbnailLayoutManager.calculateMultiThumbsHeight(doubleList1.Sublist<double>(index1, index1 + index2), width1, margin),
                ThumbnailLayoutManager.calculateMultiThumbsHeight(doubleList1.Sublist<double>(index1 + index2, doubleList1.Count), width1, margin)
              };
            }
          }
          string index3 = null;
          ...
          {
            List<double> doubleList2 = dictionary[key];
            double num6 = num2 * (double) (doubleList2.Count - 1);
            foreach (double num8 in doubleList2)
              num6 += num8;
          ...
          List<double> doubleList4 = dictionary[index3];
          ...
          for (int index1 = 0; index1 < strArray1.Length; ++index1)
          {
            ...
            double num8 = doubleList4[index4];
            ++index4;
