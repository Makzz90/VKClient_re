...
namespace VKClient.Common.Library
{
  ...
  {
    private readonly List<string> _durationTypes = new List<string>()
    {
      CommonResources.VideoSearch_Filter_Any,
      CommonResources.VideoSearch_Filter_Short,
      CommonResources.VideoSearch_Filter_Long
    };
    private readonly List<string> _sortTypes = new List<string>()
    {
      CommonResources.VideoSearch_Sort_ByRelevance,
      CommonResources.VideoSearch_Sort_ByDate,
      CommonResources.VideoSearch_Sort_ByDuration
    };
    ...
    public string DurationType
    {
      get
      {
        ...
        {
          string str = this.Parameters["filters"];
          if (str == "short")
            return this._durationTypes[1];
          if (str == "long")
            return this._durationTypes[2];
        }
        return this._durationTypes.First<string>();
      }
      set
      {
    ...
    public string SortType
    {
      get
      {
        ...
        {
          string str = this.Parameters["sort"];
          if (str == "0")
            return this._sortTypes[1];
          if (str == "1")
            return this._sortTypes[2];
        }
        return this._sortTypes.First<string>();
      }
      set
      {
