            ...
            if (resultCode == ResultCode.Succeeded)
            {
              ...
              if (provider.SupportInvitation)
              {
                ...
                if (other != null)
                {
                  ...
                  friendsImportResponse.OtherUsers = new List<ISubscriptionItemHeader>((IEnumerable<ISubscriptionItemHeader>) source.Distinct<InvitationItemHeader, string>((Func<InvitationItemHeader, string>) (header => header.Subtitle)));
                }
              }
