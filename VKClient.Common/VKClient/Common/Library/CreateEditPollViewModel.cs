  ...
  public class CreateEditPollViewModel : ViewModelBase
  {
    ...
    public string Question
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<string>((Expression<Func<string>>) (() => this.Question));
    ...
    public bool IsAnonymous
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<bool>((Expression<Func<bool>>) (() => this.IsAnonymous));
      }
    }
    ...
    public bool CanAdd
    {
      get
      {
        return this.PollOptions.Count < 10;
      }
    }
    ...
    public void AddPollOption()
    {
      ...
      this.NotifyPropertyChanged<bool>((Expression<Func<bool>>) (() => this.CanAdd));
    }
