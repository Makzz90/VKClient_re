...
namespace VKClient.Common.Library
{
  public class SettingsAccountViewModel : ViewModelBase, IHandle<HiddenNewsSourcesCountUpdated>, IHandle, IHandle<ShortNameChangedEvent>
  {
    ...
    public bool ShowOnlyMyPosts
    {
      ...
      set
      {
        ...
        AccountService.Instance.SetInfo("own_posts_default", value ? "1" : "0", (Action<BackendResult<ResponseWithId, ResultCode>>) (res =>
        {
          ...
          this.NotifyPropertyChanged<bool>((Expression<Func<bool>>) (() => this.ShowOnlyMyPosts));
          this.NotifyPropertyChanged<BGType>((Expression<Func<BGType>>) (() => this.ShowByDefaultType));
        }));
      }
    }
    ...
    public bool PostComments
    {
      ...
      set
      {
        ...
        AccountService.Instance.SetInfo("no_wall_replies", value ? "0" : "1", (Action<BackendResult<ResponseWithId, ResultCode>>) (res =>
        {
          ...
          this._isLoading = false;
          this.NotifyPropertyChanged<bool>((Expression<Func<bool>>) (() => this.PostComments));
        }));
      }
    }
    ...
    public string NewsFilterDescStr
    {
      get
      {
        int num = this._hiddenSourcesCount;
        if (num > 0)
          return CommonResources.SettingsAccount_NotShown + ": " + num.ToString();
        return " ";
      }
    }
    ...
    public void LoadData()
    {
      ...
      AccountService.Instance.GetSettingsAccountInfo((Action<BackendResult<SettingsAccountInfo, ResultCode>>) (res =>
      {
        this.SetInProgress(false, "");
        if (res.ResultCode != ResultCode.Succeeded)
          GenericInfoUC.ShowBasedOnResult((int) res.ResultCode, "", (VKRequestsDispatcher.Error) null);
        else
          Execute.ExecuteOnUIThread((Action) (() => this.ReadData(res.ResultData)));
        this._isLoading = false;
      }));
    }
    ...
    private void ReadData(SettingsAccountInfo settingsAccountInfo)
    {
      ...
      this.NotifyPropertyChanged<string>((Expression<Func<string>>) (() => this.NewsFilterDescStr));
      this.NotifyPropertyChanged<bool>((Expression<Func<bool>>) (() => this.PostComments));
      this.NotifyPropertyChanged<bool>((Expression<Func<bool>>) (() => this.ShowOnlyMyPosts));
