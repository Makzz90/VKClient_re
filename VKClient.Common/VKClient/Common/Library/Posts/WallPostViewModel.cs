...
namespace VKClient.Common.Library.Posts
{
    public class WallPostViewModel : ViewModelBase, IBinarySerializable
    {
        ...
        public WallPostViewModel.Mode WMMode
        {
            ...
            set
            {
                ...
                if (this.CanAddMoreAttachments)
                    return;
                IOutboundAttachment outboundAttachment = this._outboundAttachmentsWithAdd.FirstOrDefault<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a is OutboundAddAttachment));
                if (outboundAttachment == null)
                    return;
                this._outboundAttachmentsWithAdd.Remove(outboundAttachment);
            }
        }
        ...
        public bool IsDirty
        {
            get
            {
                if (!string.IsNullOrWhiteSpace(this.Text) || this._outboundAttachments.Count > 0)
        ...
        public string UniqueId
        {
            get
            {
                string str = ((int)this._mode).ToString() + "_" + this.IsNewPostSuggested.ToString();
                switch (this._mode)
                {
                    ...
                    case WallPostViewModel.Mode.EditProductComment:
                        return str;
                    default:
                        return str + "_" + (object)this.UserOrGroupId + "_" + this.IsGroup.ToString();
                }
            }
        }
        ...
        public bool IsNewPostPostponed
        {
            get
            {
                if (this._mode == WallPostViewModel.Mode.NewWallPost && this._outboundAttachments != null)
                    return this._outboundAttachments.FirstOrDefault<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a.AttachmentId == "timestamp")) != null;
                return false;
            }
        }
                ...
                switch (this._mode)
                {
                    case WallPostViewModel.Mode.NewWallPost:
                        if (this._isPublicPage && this._adminLevel < 2)
                            return CommonResources.SuggestedNews_SuggestAPost.ToUpperInvariant();
                    ...
                    case WallPostViewModel.Mode.NewProductComment:
                        return UIStringFormatterHelper.FormatNumberOfSomething(this._outboundAttachments.Count, CommonResources.OneAttachmentFrm, CommonResources.ManageAttachments_TwoFourAttachmentsFrm, CommonResources.ManageAttachments_FiveMoreAttachmentsFrm, true, (string)null, false).ToUpperInvariant();
                    case WallPostViewModel.Mode.EditWallComment:
                    case WallPostViewModel.Mode.EditPhotoComment:
                    case WallPostViewModel.Mode.EditVideoComment:
                    case WallPostViewModel.Mode.EditDiscussionComment:
                    ...
                    case WallPostViewModel.Mode.PublishWallPost:
                        return CommonResources.SuggestedNews_Publish.ToUpperInvariant();
                    default:
                        return "";
                }
            }
        ...
        public Visibility IsInNewTopicModeVisibility
        {
            get
            {
                return !this.IsInNewTopicMode ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility HaveRepostVisibility
        {
            get
            {
                return !this._editWallRepost ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility OwnPostVisibility
        {
            get
            {
                return this._userOrGroupId != AppGlobalStateManager.Current.LoggedInUserId || !this.IsInNewWallPostMode ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility TwitterVisibility
        {
            get
            {
                return this._userOrGroupId != AppGlobalStateManager.Current.LoggedInUserId || this._friendsOnly || (AppGlobalStateManager.Current.GlobalState.LoggedInUser.exports.twitter != 1 || !this.IsInNewWallPostMode) ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility FacebookVisibility
        {
            get
            {
                return this._userOrGroupId != AppGlobalStateManager.Current.LoggedInUserId || this._friendsOnly || (AppGlobalStateManager.Current.GlobalState.LoggedInUser.exports.facebook != 1 || !this.IsInNewWallPostMode) ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public bool CanPublish
        {
            get
            {
                ...
                Func<IOutboundAttachment, bool> predicate1 = (Func<IOutboundAttachment, bool>)(a => a.AttachmentId != "timestamp");

                if (outboundAttachments1.Any<IOutboundAttachment>(predicate1) || !string.IsNullOrWhiteSpace(this._text))
                {
                    ObservableCollection<IOutboundAttachment> outboundAttachments2 = this.OutboundAttachments;
                    Func<IOutboundAttachment, bool> predicate2 = (Func<IOutboundAttachment, bool>)(a => a.UploadState == OutboundAttachmentUploadState.Completed);
                    if (outboundAttachments2.All<IOutboundAttachment>(predicate2) && this._mode != WallPostViewModel.Mode.NewTopic)
                        goto label_6;
                }
                if (this._mode != WallPostViewModel.Mode.EditWallPost || !this._editWallRepost)
                {
                    if (this._mode == WallPostViewModel.Mode.NewTopic && !string.IsNullOrWhiteSpace(this._topicTitle) && !string.IsNullOrWhiteSpace(this._text))
                        return this.OutboundAttachments.All<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a.UploadState == OutboundAttachmentUploadState.Completed));
                    return false;
                }
            label_6:
                return true;
        ...
        public bool FromGroupIsEnabled
        {
            get
            {
                return this._outboundAttachmentsWithAdd.FirstOrDefault<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a.AttachmentId == "timestamp")) == null;
            }
        }
        ...
        public Visibility FromGroupVisibility
        {
            get
            {
                return (this._adminLevel <= 1 || !this._isGroup || (this._isPublicPage || !this.IsInNewWallPostMode)) && (this._adminLevel <= 1 || !this.IsInNewTopicMode) ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public Visibility SignatureVisibility
        {
            get
            {
                return (this._adminLevel <= 1 || !this._isGroup || !this.IsInNewWallPostMode || !this.FromGroup && !this._isPublicPage) && ((!this.IsPostponed || !this._isGroup) && this.WMMode != WallPostViewModel.Mode.PublishWallPost) ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        public int NumberOfAttAllowedToAdd
        {
            get
            {
                switch (this._mode)
                {
                    case WallPostViewModel.Mode.EditWallPost:
                        if (!this._editWallRepost)
                            return Math.Max(0, 10 - this._outboundAttachments.Count);
                        return 0;
                    case WallPostViewModel.Mode.NewWallComment:
                    case WallPostViewModel.Mode.EditWallComment:
                    case WallPostViewModel.Mode.EditPhotoComment:
                    ...
                    case WallPostViewModel.Mode.NewProductComment:
                    case WallPostViewModel.Mode.EditProductComment:
                        return Math.Max(0, 2 - this._outboundAttachments.Count);
                    default:
                        return Math.Max(0, 10 - this._outboundAttachments.Count<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a.AttachmentId != "timestamp")));
                }
            }
        }
        ...
        public bool CanAddPollAttachment
        {
            get
            {
                if (this._mode == WallPostViewModel.Mode.EditWallPost || this._mode == WallPostViewModel.Mode.NewWallPost || this._mode == WallPostViewModel.Mode.PublishWallPost)
                    return !this.OutboundAttachments.Any<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a is OutboundPollAttachment));
                return false;
            }
        }
        ...
        public bool CannAddTimerAttachment
        {
            get
            {
                if ((this.IsInNewWallPostMode || this.IsPostponed || this.IsSuggested) && ((this.IsGroupAdmin || this.IsCurrentUser) && !this.IsNewPostSuggested))
                    return !this.OutboundAttachments.Any<IOutboundAttachment>((Func<IOutboundAttachment, bool>)(a => a is OutboundTimerAttachment));
                return false;
            }
        }
        ...
        public void Write(BinaryWriter writer)
        {
            ...
            List<OutboundAttachmentContainer> list = this._outboundAttachments.Select<IOutboundAttachment, OutboundAttachmentContainer>((Func<IOutboundAttachment, OutboundAttachmentContainer>)(a => new OutboundAttachmentContainer(a))).ToList<OutboundAttachmentContainer>();
            ...
            writer.WriteDictionary(this._cidToAuthorIdDict);
        ...
        internal static WallPostViewModel CreateNewWallCommentVM(long ownerId, long postId)
        {
            ...
            {
                date = Extensions.DateTimeToUnixTimestamp(DateTime.UtcNow, true),
                from_id = AppGlobalStateManager.Current.LoggedInUserId,
                text = "",
                likes = new Likes() { can_like = 1 }
            };
        ...
        private void InitializeWithWallPost(WallPost wallPost, int adminLevel, WallRepostInfo wallRepostInfo = null)
        {
            ...
            if (wallPost.geo != null)
            {
                ...
                this.OutboundAttachments.Add((IOutboundAttachment)new OutboundGeoAttachment(latitude, longitude));
            }
            if (wallPost.IsPostponed)
            {
                this.IsPostponed = true;
                this.OutboundAttachments.Add((IOutboundAttachment)new OutboundTimerAttachment(new TimerAttachment()
                {
        ...
        private void InitializeAttachments(List<Attachment> attachments)
        {
            ...
            {
                IOutboundAttachment outboundAttachment = (IOutboundAttachment)null;
                if (attachment.photo != null)
                    outboundAttachment = (IOutboundAttachment)OutboundPhotoAttachment.CreateForChoosingExistingPhoto(attachment.photo, 0L, false, PostType.WallPost);
                if (attachment.video != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundVideoAttachment(attachment.video);
                if (attachment.audio != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundAudioAttachment(attachment.audio);
                if (attachment.doc != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundDocumentAttachment(attachment.doc);
                if (attachment.poll != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundPollAttachment(attachment.poll);
                if (attachment.link != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundLinkAttachment(attachment.link);
                if (attachment.note != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundNoteAttachment(attachment.note);
                if (attachment.market_album != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundMarketAlbumAttachment(attachment.market_album);
                if (attachment.album != null)
                    outboundAttachment = (IOutboundAttachment)new OutboundAlbumAttachment(attachment.album);
                if (outboundAttachment != null)
                    this.OutboundAttachments.Add(outboundAttachment);
                else
                    this._uneditableAttachments.Add(attachment);
            }
        }
        ...
        {
            EventAggregator.Current.Publish((object)new TopicCreated()
            {
        ...
        private void UpdateCommentAndFireTheCommentEditedEvent()
        {
            ...
            this._comment.Attachments = new List<Attachment>(this.OutboundAttachments.Select<IOutboundAttachment, Attachment>((Func<IOutboundAttachment, Attachment>)(oa => oa.GetAttachment())));
            EventAggregator.Current.Publish((object)new CommentEdited()
            {
        ...
        private void FireWallPostAddedOrEditedEvent(long postId, long ownerId, bool added = true, Action callback = null)
        {
            WallService.Current.GetWallPostByIdWithComments(postId, ownerId, 0, 0, 0, true, (Action<BackendResult<GetWallPostResponseData, ResultCode>>)(res =>
            {
                if (res.ResultData.WallPost == null || res.ResultData.Users == null || res.ResultData.Groups == null)
                    return;
                EventAggregator.Current.Publish((object)new WallPostAddedOrEdited()
                {
                    NewlyAddedWallPost = res.ResultData.WallPost,
                    Users = res.ResultData.Users,
                    Groups = res.ResultData.Groups,
                    Edited = !added
                });
        ...
        public void UpdateUploadingStatus(bool forceTrue = false)
        {
            ...
            if (outboundAttachments.All<IOutboundAttachment>(predicate) && !forceTrue)
                this.SetInProgress(false, "");
            else
