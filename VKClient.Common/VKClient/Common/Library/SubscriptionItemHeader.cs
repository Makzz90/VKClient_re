...
namespace VKClient.Common.Library
{
  public class SubscriptionItemHeader : ISubscriptionItemHeader, IHaveUniqueKey, INotifyPropertyChanged, IHandle<GroupMembershipStatusUpdated>, IHandle
  {
    ...
    public Visibility VerifiedIconVisibility
    {
      get
      {
        return !this._isVerified ? Visibility.Collapsed : Visibility.Visible;
      }
    }
    ...
    public Visibility SubscribeVisibility
    {
      get
      {
        return this._canSubscribe && !this._isInProgress ? Visibility.Visible : Visibility.Collapsed;
      }
    }
    ...
    public Visibility IsInProgressVisibility
    {
      get
      {
        return !this._isInProgress ? Visibility.Collapsed : Visibility.Visible;
      }
    }
    ...
    {
      if (this._user != null)
        return "user" + (object) this._user.id;
      if (this._group != null)
        return "group" + (object) this._group.id;
      return "";
    }
