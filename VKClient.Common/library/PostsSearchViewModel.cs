...
namespace VKClient.Common.Library
{
  public class PostsSearchViewModel : ViewModelBase, ICollectionDataProvider2<WallData, IVirtualizable>, ISearchWallPostsViewModel
  {
    ...
    public GenericCollectionViewModel2<WallData, IVirtualizable> SearchVM { get; private set; }
    ...
    public string Query
    {
      ...
      private set
      {
        ...
        this.NotifyPropertyChanged<Visibility>(() => this.NewsVisibility);
      }
    }
    ...
    public int ItemsCount
    {
      get
      {
        return ((Collection<IVirtualizable>) this.SearchVM.Collection).Count;
      }
    }
