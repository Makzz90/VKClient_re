...
namespace VKClient.Common.Library
{
    ...
    {
        private static readonly List<BGType> _birthdayShowTypesList = new List<BGType>() { new BGType() { id = 1, name = CommonResources.Settings_EditProfile_ShowDayMonthAndYear }, new BGType() { id = 2, name = CommonResources.Settings_EditProfile_ShowDayAndMonth }, new BGType() { id = 0, name = CommonResources.Settings_EditProfile_DoNotShow } };
        ...
        public string RelationRequestsText
        {
            get
            {
                ...
                {
                    User relationRequest = this._profileInfo.relation_requests[0];
                    return string.Format(relationRequest.IsFemale ? CommonResources.Settings_EditProfile_SomebodyIsInLoveWithYouFemaleFrm : CommonResources.Settings_EditProfile_SomebodyIsInLoveWithYouMaleFrm, relationRequest.NameLink);
                }
                string commaSeparated = ((List<string>)Enumerable.ToList<string>(Enumerable.Select<User, string>(this._profileInfo.relation_requests, (Func<User, string>)(u => u.NameLink)))).GetCommaSeparated(", ");
                string.Format(CommonResources.Settings_EditProfile_SomebodyIsInLoveWithYouManyFrm, commaSeparated);
        ...
        public DateTime BirthDateValue
        {
            get
            {
                ...
                if (!this.IsBDateSet)
                    return dateTime;
                string[] strArray = this._profileInfo.bdate.Split((char[])new char[1] { '.' });
        ...
        public BGType BirthdayShowType
        {
            ...
            {
                if (this._profileInfo != null)
                    return (BGType)Enumerable.FirstOrDefault<BGType>(SettingsEditProfileViewModel._birthdayShowTypesList, (Func<BGType, bool>)(b => b.id == this._profileInfo.bdate_visibility));
                return (BGType)Enumerable.First<BGType>(SettingsEditProfileViewModel._birthdayShowTypesList);
            }
            set
            {
        ...
        public BGType RelationshipType
        {
            ...
            {
                if (this._profileInfo != null)
                    return (BGType)Enumerable.FirstOrDefault<BGType>(this.RelationshipTypes, (Func<BGType, bool>)(r => r.id == this._profileInfo.relation));
                return (BGType)Enumerable.First<BGType>(this.RelationshipTypes);
            }
            set
            {
                if (value == null || this._profileInfo == null)
        ...
        static SettingsEditProfileViewModel()
        {
            ...
            bgType6.id = 8;
            string lowerInvariant6 = CommonResources.InCivilUnion.ToLowerInvariant();
            bgType6.name = lowerInvariant6;
            bgTypeList1.Add(bgType6);
            BGType bgType7 = new BGType();
            bgType7.id = 7;
            string lowerInvariant7 = CommonResources.Relationship_InLove_Male.ToLowerInvariant();
            bgType7.name = lowerInvariant7;
            bgTypeList1.Add(bgType7);
            BGType bgType8 = new BGType();
            bgType8.id = 5;
            string lowerInvariant8 = CommonResources.Relationship_ItIsComplicated.ToLowerInvariant();
            bgType8.name = lowerInvariant8;
            bgTypeList1.Add(bgType8);
            BGType bgType9 = new BGType();
            bgType9.id = 6;
            string lowerInvariant9 = CommonResources.Relationship_ActivelySearching.ToLowerInvariant();
            ...
            bgType10.id = 0;
            string lowerInvariant10 = CommonResources.Settings_EditProfile_NoneSelected.ToLowerInvariant();
            bgType10.name = lowerInvariant10;
            bgTypeList2.Add(bgType10);
            BGType bgType11 = new BGType();
            bgType11.id = 1;
            string lowerInvariant11 = CommonResources.Relationship_Single_Female.ToLowerInvariant();
            bgType11.name = lowerInvariant11;
            bgTypeList2.Add(bgType11);
            BGType bgType12 = new BGType();
            bgType12.id = 2;
            string lowerInvariant12 = CommonResources.Relationship_InARelationship_Female.ToLowerInvariant();
            bgType12.name = lowerInvariant12;
            bgTypeList2.Add(bgType12);
            BGType bgType13 = new BGType();
            bgType13.id = 3;
            string lowerInvariant13 = CommonResources.Relationship_Engaged_Female.ToLowerInvariant();
            bgType13.name = lowerInvariant13;
            bgTypeList2.Add(bgType13);
            BGType bgType14 = new BGType();
            bgType14.id = 4;
            string lowerInvariant14 = CommonResources.Relationship_Married_Female.ToLowerInvariant();
            bgType14.name = lowerInvariant14;
            bgTypeList2.Add(bgType14);
            BGType bgType15 = new BGType();
            bgType15.id = 8;
            string lowerInvariant15 = CommonResources.InCivilUnion.ToLowerInvariant();
            ...
            bgType17.id = 5;
            string lowerInvariant17 = CommonResources.Relationship_ItIsComplicated.ToLowerInvariant();
            bgType17.name = lowerInvariant17;
            bgTypeList2.Add(bgType17);
            BGType bgType18 = new BGType();
            bgType18.id = 6;
            string lowerInvariant18 = CommonResources.Relationship_ActivelySearching.ToLowerInvariant();
        ...
        {
            this._profileInfo.country = null;
        ...
        {
            AccountService.Instance.GetSettingsProfileInfo(delegate(BackendResult<ProfileInfo, ResultCode> result)
            {
