...
namespace VKClient.Common.Library
{
  ...
  {
      public IEnumerable<DocumentHeader> LocalItems { get; private set; }
    ...
    public Func<VKList<Doc>, ListWithCount<DocumentHeader>> ConverterFunc
    {
      get
      {
          return (Func<VKList<Doc>, ListWithCount<DocumentHeader>>)(list => new ListWithCount<DocumentHeader>() { TotalCount = list.count, List = (List<DocumentHeader>)Enumerable.ToList<DocumentHeader>(Enumerable.Select<Doc, DocumentHeader>(list.items, (Func<Doc, DocumentHeader>)(i => new DocumentHeader(i, 0, false, 0L)))) });
      }
    }
