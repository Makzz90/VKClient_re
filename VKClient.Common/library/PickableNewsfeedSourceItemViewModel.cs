...
namespace VKClient.Common.Library
{
  public class PickableNewsfeedSourceItemViewModel : ViewModelBase
  {
    ...
    public PickableItem PickableItem { get; private set; }
        ...
        switch (id)
        {
          ...
          default:
            ...
            if ((ulong) num1 <= (ulong) num2)
            {
              ...
              {
                case 0:
                  return "/Resources/MainMenu/News32px.png";
                case 1:
    ...
    public bool IsSelected
    {
      ...
      set
      {
        ...
        base.NotifyPropertyChanged<double>(() => this.Opacity);
      }
    }
    ...
    public bool IsTopNewsToggleChecked
    {
      ...
      set
      {
        ...
        EventAggregator.Current.Publish(new NewsfeedTopEnabledDisabledEvent());
      }
    }
