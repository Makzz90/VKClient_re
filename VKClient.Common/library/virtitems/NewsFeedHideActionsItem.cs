  ...
  public class NewsFeedHideActionsItem : VirtualizableItemBase
  {
    ...
    private void CreateLayout()
    {
      if (this._actionsUC == null)
      {
        ...
        ((FrameworkElement) feedHideActionsUc).Width = width;
        ...
        this.VirtualizableChildren.Add((IVirtualizable) new UCItem(this.Width, this.Margin, (Func<UserControlVirtualizable>) (() => (UserControlVirtualizable) this._actionsUC), (Func<double>) (() => this.FixedHeight),  null, 0.0, false));
      }
