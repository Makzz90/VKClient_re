  ...
  public class UserNotificationNewsfeedItem : VirtualizableItemBase, IHaveUniqueKey
  {
    ...
    private void CreateLayout()
    {
      if (this._notificationUC == null)
      {
        ...
        ((FrameworkElement) newsfeedNotificationUc).Width = width;
        ...
        this.VirtualizableChildren.Add((IVirtualizable) new UCItem(this.Width, this.Margin, (Func<UserControlVirtualizable>) (() => (UserControlVirtualizable) this._notificationUC), (Func<double>) (() => this.FixedHeight),  null, 0.0, false));
      }
    ...
    {
      return string.Format("notification{0}", this.Id);
    }
  }
}
