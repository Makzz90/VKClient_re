...
namespace VKClient.Common.Library
{
  public static class CommentsItemsGeneratorHelper
  {
    ...
    {
      return CommentsItemsGeneratorHelper.CreateCommentsCountItem(width, (Func<string>) (() => CommentsItemsGeneratorHelper.GetTextForCommentsCount(commentsCount)), 0.0,  null);
    }
    ...
    {
      TextSeparatorUC commentsCountSeparatorUC = new TextSeparatorUC() { Text = getText() };
      if (background != null)
        ((Panel) commentsCountSeparatorUC.gridViewedFeedback).Background = ((Brush) background);
      return (VirtualizableItemBase) new UCItem(480.0, new Thickness(0.0, topMargin, 0.0, 0.0), (Func<UserControlVirtualizable>) (() => (UserControlVirtualizable) commentsCountSeparatorUC), (Func<double>) (() => 56.0),  null, 0.0, false);
    }
    ...
    {
      return new CommentItem(width - 32.0, new Thickness(8.0, 0.0, 0.0, CommentsItemsGeneratorHelper.MarginBetweenComments), likeObjType, deleteCallback, replyCallback, editCallback, ownerId, comment, user, user2, group,  null, "", "",  null, false, false, "");
    }
