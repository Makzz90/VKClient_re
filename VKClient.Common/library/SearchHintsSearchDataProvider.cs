  ...
  public class SearchHintsSearchDataProvider : ISearchDataProvider<SearchHint, SearchHintHeader>
  {
    ...
    public Func<VKList<SearchHint>, ListWithCount<SearchHintHeader>> ConverterFunc
    {
      get
      {
        ...
        {
          ListWithCount<SearchHintHeader> listWithCount = new ListWithCount<SearchHintHeader>() { TotalCount = res.count };
    ...
    public static void Reset()
    {
      ...
      SearchHintsSearchDataProvider._preloadedSearchHints =  null;
      SearchHintsSearchDataProvider._preloadedSearchHintsHeaders =  null;
    }
