  ...
  public class OutboundUploadDocumentAttachment : OutboundAttachmentBase
  {
    ...
    public override string AttachmentId
    {
      get
      {
        if (this.SavedDoc == null)
          return "";
        return "doc" + this.SavedDoc.owner_id + "_" + this.SavedDoc.id;
      }
    }
    ...
    private Doc SavedDoc
    {
      ...
      set
      {
        ...
        this.DocumentHeader = new DocumentHeader(this._savedDoc, 0, false, 0L);
      }
    }
    ...
    public override async void Upload(Action completionCallback, Action<double> progressCallback = null)
    {
        ...
        else
        {
            ...
            DocumentsService.Current.UploadDocument(0, this._sf.Name, this._sf.FileType, stream, (Action<BackendResult<Doc, ResultCode>>)(response =>
            {
